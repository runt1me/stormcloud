...
class PaymentProcessingTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.connect_button = AnimatedButton("Connect to Stripe")
        ...
        self.export_bills_btn = AnimatedButton("Export to CSV")
...
class MeetingSchedulerTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_user_btn = AnimatedButton("Add User")
        self.add_user_btn.clicked.connect(self.add_user)
        self.remove_user_btn = AnimatedButton("Remove User")
        self.remove_user_btn.clicked.connect(self.remove_user)
        self.import_users_btn = AnimatedButton("Import Users")
        ...
        self.add_meeting_btn = AnimatedButton("Add Meeting")
        self.add_meeting_btn.clicked.connect(self.add_meeting)
        self.remove_meeting_btn = AnimatedButton("Remove Meeting")
        self.remove_meeting_btn.clicked.connect(self.remove_meeting)
        self.import_meetings_btn = AnimatedButton("Import Meetings")
        self.import_meetings_btn.clicked.connect(self.import_meetings)
        self.schedule_btn = AnimatedButton("Schedule All Meetings")
